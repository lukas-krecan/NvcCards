...
export const needs: Card[] = [
  ...
  {id: 'n2', data: [{text: 'Dotek'}, {text: 'projevení náklonnosti'}]},
  {
    ...
    data: [
      {text: 'Integrita'},
      {text: 'soulad mezi tím co říkám,'},
      {text: 'a co dělám', size: 3},
    ],
  },
  {
    id: 'n4',
    data: [
      {text: 'Klid'},
      {text: 'možnost dělat věci svým tempem'},
      {text: 'Klid v duši', size: 3},
    ],
  },
  ...
  {id: 'n6', data: [{text: 'Dobrodružství'}, {text: 'Výzva'}]},
  {
    ...
    data: [
      {text: 'Důvěra'},
      {text: 'Důvěřovat, spolehnout se', size: 2},
      {text: 'mít něčí důvěru'},
    ],
  },
  {
    id: 'n8',
    data: [
      {text: 'Jasnost'},
      {text: 'mít jasno, orientovat se', size: 2},
      {text: 'vyznat se v tom', size: 2},
    ],
  },
  {id: 'n9', data: [{text: 'Harmonie'}, {text: 'Soulad, Krása'}]},
  {
    ...
    data: [
      {text: 'Autonomie'},
      {text: 'Nezávislost, samostatnost'},
      {text: 'Vliv na věci, které se mě týkají, možnost volby'},
    ],
  },
  ...
  {
    id: 'n14',
    data: [{text: 'Ocenění, uznání'}, {text: 'pozornost, být viděn'}],
  },
  {
    id: 'n15',
    data: [
      {text: 'Dávání, Přispění'},
      {text: 'Obohacování života druhých'},
      {text: 'svým konáním', size: 3},
    ],
  },
  {
    id: 'n16',
    data: [
      {text: 'Být pochopen'},
      {text: 'být slyšen, být vnímán', size: 2},
      {text: 'empatie', size: 2},
    ],
  },
  ...
  {
    id: 'n18',
    data: [{text: 'Rozumět, Chápat'}, {text: 'Vědět, být informován'}],
  },
  ...
  {id: 'n20', data: [{text: 'Progres'}, {text: 'Efektivita'}]},
  {
    ...
    data: [
      {text: 'Prostor'},
      {text: 'Prostornost ve fyzickém prostoru'},
      {text: 'v čase, v konverzaci', size: 3},
    ],
  },
  {
    id: 'n22',
    data: [
      {text: 'Respekt'},
      {text: 'být brán vážně', size: 2},
      {text: 'pocit "na mě záleží"', size: 2},
    ],
  },
  {id: 'n23', data: [{text: 'Sdílení'}]},
  {
    id: 'n24',
    data: [{text: 'Moc, vliv'}, {text: 'Vliv na věci, které se mě týkají'}],
  },
  ...
  {
    id: 'n29',
    data: [{text: 'Smysl'}, {text: 'smysluplnost, významnost, hloubka'}],
  },
  {
    id: 'n30',
    data: [
      {text: 'Sounáležitost'},
      {text: 'být s lidmi, nebýt sám'},
      {text: 'být součástí party, někam patřit'},
    ],
  },
  {
    id: 'n31',
    data: [
      {text: 'Spolupráce'},
      {text: 'pracovat na věci společně'},
      {text: 'společně dosahovat výsledků'},
    ],
  },
  {
    id: 'n32',
    data: [
      {text: 'Férovost'},
      {text: 'Přiměřenost', size: 2},
      {text: 'Vzájemnost', size: 2},
    ],
  },
  {
    id: 'n33',
    data: [{text: 'Přijetí'}, {text: 'Být přijímán takový jaký jsem'}],
  },
  ...
  {id: 'n36', data: [{text: 'Spontánnost'}, {text: 'Autentičnost'}]},
  {
    ...
    data: [
      ...
      {text: 'Otevřenost', size: 2},
      {text: 'Přímost (nechodit kolem horké kaše)'},
    ],
  },
  {id: 'n38', data: [{text: 'Požitek'}, {text: 'potěšení smyslů'}]},
  {
    id: 'n39',
    data: [{text: 'Intimita'}, {text: 'blízkost, hloubka sdíleného prožívání'}],
  },
  {id: 'n40', data: [{text: 'Hra'}, {text: 'hravost, soutěžení'}]},
  {
    ...
    data: [
      {text: 'Kompetence'},
      {text: 'Mistrovství', size: 2},
      {text: 'ovládnutí dovednosti', size: 3},
    ],
  },
  {id: 'n42', data: [{text: 'Pozornost'}, {text: 'Být slyšen, Být viděn'}]},
  {
    id: 'n43',
    data: [
      {text: 'Zdravi, Svěžest'},
      {text: 'tělesná, duševní'},
      {text: 'býtí ve své plné síle'},
    ],
  },
  {
    id: 'n44',
    data: [
      {text: 'Přesah'},
      {text: 'Spiritualita, Transcendence'},
      {text: 'kontakt s něčím, co nás přesahuje'},
    ],
  },
...
export const feelings: Card[] = [
  ...
  {
    id: 'f6',
    data: [{text: 'Rozladění'}, {text: 'Podráždění, Rozhořčení', size: 2}],
  },
  ...
  {id: 'f16', data: [{text: 'Nervozita'}]},
  {id: 'f39', data: [{text: 'Nuda'}]},
  {id: 'f17', data: [{text: 'Hořkost'}]},
  {
    id: 'f18',
    data: [
      {text: 'Otupělost'},
      {text: 'Netečnost, odpojení', size: 2},
      {text: 'rezignace', size: 2},
    ],
  },
  ...
  {
    id: 'f25',
    data: [{text: 'Inspirace'}, {text: 'Fascinace, Okouzlení', size: 2}],
  },
  {
    id: 'f26',
    data: [
      {text: 'Radost'},
      {text: 'štěstí, veselost', size: 2},
      {text: 'potěšení', size: 2},
    ],
  },
  {
    id: 'f27',
    data: [{text: 'Vyrovnanost'}, {text: 'Rovnováha, Sebejistota', size: 2}],
  },
